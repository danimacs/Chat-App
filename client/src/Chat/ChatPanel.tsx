        ...
        <div className="col-md-4 col-12 card-stacked">
            <div className="card shadow-line mb-3 chat">
                    ...
                    <div className="w-100">
                        <div className="d-flex pl-0">
                            <div className="d-flex flex-row mt-1">
                                <span className="margin-auto mr-2">
                                    <div className="svg15 archived"></div>
                                </span>
                                <p className="margin-auto fw-400 text-dark-75">Archived</p>
                            </div>
                            <div>
                            </div>
                        </div>
                ...
                <div className="chat-user-panel">
                    <div
                        className="pb-3 d-flex flex-column navigation-mobile pagination-scrool chat-user-scroll">
                        <div className="chat-item d-flex pl-3 pr-0 pt-3 pb-3">
                            <div className="w-100">
                                <div className="d-flex pl-0">
                                    ...
                                    <div>
                                        <p className="margin-auto fw-400 text-dark-75">Emily
                                            Woods</p>
                                        <div className="d-flex flex-row mt-1">
                                            <span>
                                            ...
                                            <span
                                                className="message-shortcut margin-auto text-muted fs-13 ml-1 mr-4">I'm
                        ...
                        <div className="chat-item active d-flex pl-3 pr-0 pt-3 pb-3">
                            <div className="w-100">
                                <div className="d-flex pl-0">
                                    ...
                                    <div>
                                        <p className="margin-auto fw-400 text-dark-75">Beate
                                            Lemoine</p>
                                        <div className="d-flex flex-row mt-1">
                                            <span>
                                                <div className="svg15 double-check"></div>
                                            ...
                                            <span
                                                className="message-shortcut margin-auto fw-400 fs-13 ml-1 mr-4">Hey
                                                Quan, If you are free now we can meet tonight
                                                ?</span>
                                        </div>
                                    </div>
                                </div>
